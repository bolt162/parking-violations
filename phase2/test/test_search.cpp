...
// -- Cross-validate: Parallel vs Indexed give same results --

static void test_cross_validation() {
    std::cout << "\n=== Cross-Validation (Parallel vs Indexed) ===" << std::endl;
